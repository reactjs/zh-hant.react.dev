...
_Component_ 是 React 的核心概念之一，它們是建構使用者介面 (UI) 的基礎，是你踏上 React 旅程的完美開端！
...
## Component：UI 的建構塊 {/_components-ui-building-blocks_/}
...
## 定義 component {/_defining-a-component_/}
...
### 第一步： Export component {/_step-1-export-the-component_/}
...
### 第二步：定義函式 {/_step-2-define-the-function_/}
...
### 第三步：添加 markup {/_step-3-add-markup_/}
...
## 使用 component {/_using-a-component_/}
...
### 瀏覽器所看到的 {/_what-the-browser-sees_/}
...
### 嵌套與組織 component {/_nesting-and-organizing-components_/}
...
#### 萬物皆是 component {/_components-all-the-way-down_/}
...
#### Export component {/_export-the-component_/}
...
#### 修復回傳內容 {/_fix-the-return-statement_/}
...
#### 自定義 component {/_your-own-component_/}
