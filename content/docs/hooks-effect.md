...
這個範例基於的 [上一頁的反面範例](/docs/hooks-state.html)，但是我們添加了一個新的功能：我們把文件標題設置為包含了點擊次數的自定義信息。
...
> 注意
>
> 我們不必從 effect 中回傳命名了的 function。我們在這裡將其稱為`清除`以明確它的目的，但是你可以回傳 arrow function 或者叫它別的名字。
